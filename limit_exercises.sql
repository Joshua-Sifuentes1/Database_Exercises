...
-- Try to think of your results as batches, or sets. The first five results are your first batch. 
-- The five after that would be your second batch, etc. Update the query to find the tenth batch of results. 
